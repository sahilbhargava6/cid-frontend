    ...
    <>
      ...
      >
        ...
        >
          ...
          <div 
            className="absolute left-[216px] top-[620px] w-[1488px] h-[720px] rounded-[30px] z-10 p-12 shadow-sm border border-slate-100/50 bg-white/40 backdrop-blur-md grid grid-cols-12 gap-12"
          >
