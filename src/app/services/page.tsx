  ...
  return (
    ...
    >
      ...
      >
        ...
        <Link href={user ? "/dashboard?book=procurement" : "/login?book=procurement"} className="absolute left-[166px] top-[490px] w-[309px] h-[309px] rounded-[30px] overflow-hidden shadow-lg border border-slate-100 hover:scale-105 transition-transform duration-300 z-10 cursor-pointer">
          <Image 
        ...
        <Link href={user ? "/dashboard?book=accounts_and_logistics" : "/login?book=accounts_and_logistics"} className="absolute left-[486px] top-[495px] w-[309px] h-[309px] rounded-[30px] overflow-hidden shadow-lg border border-slate-100 hover:scale-105 transition-transform duration-300 z-10 cursor-pointer">
          <Image 
        ...
        <Link href={user ? "/dashboard?book=tax_prep" : "/login?book=tax_prep"} className="absolute left-[807px] top-[495px] w-[309px] h-[309px] rounded-[30px] overflow-hidden shadow-lg border border-slate-100 hover:scale-105 transition-transform duration-300 z-10 cursor-pointer">
          <Image 
        ...
        <Link href={user ? "/dashboard?book=solar" : "/login?book=solar"} className="absolute left-[1127px] top-[495px] w-[310px] h-[309px] rounded-[30px] overflow-hidden shadow-lg border border-slate-100 hover:scale-105 transition-transform duration-300 z-10 cursor-pointer">
          <Image 
        ...
        <Link href={user ? "/dashboard?book=virtual_bookkeeping" : "/login?book=virtual_bookkeeping"} className="absolute left-[1444px] top-[495px] w-[309px] h-[309px] rounded-[30px] overflow-hidden shadow-lg border border-slate-100 hover:scale-105 transition-transform duration-300 z-10 cursor-pointer">
          <Image 
